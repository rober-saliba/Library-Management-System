	...
	protected void handleMessageFromClient(Object msg, ConnectionToClient client) {
      ...
      try {
		...
		if (clientMsg.getTask().equals(ConstantsAndGlobalVars.getEarliestReturnDateTask)) {
		    ...
		    String earliestReturnDate = dbController.getEarliestReturnDate(catalogNumber); // Fetch from DBController
		    System.out.println("Earliest return date fetched: " + earliestReturnDate);
