...
/**
 * This class controls the functionality of the {@link entity.Reservations}
...
public class ReservationsController implements IClient {
	 ...
	 * messages to the server. reservationsSingleton - the single instance of this
	 * class sem1 - a semaphore that blocks the main thread until a response is
	 * received from the server. semaphore is acquired each time a request to the
	 * server is sent and released after the response arrives. result - an ArrayList
	 * of Reservation objects that store the return results from the server.
	 */
	...
	/**
	 * sends a request to the server to fetch a list of pending reservations of a
	 * specific user.
	 * 
