...
public class HistoryController implements IClient {
	 ...
	 * messages to the server. faultsHistoryController - the single instance of this
	 ...
	 * containing History objects that store the return result from the server.
	 */
	...
	/**
	 * sends a request to the server to get all history (inactive borrows and
	 * reservations) for the passed user.
	 * 
