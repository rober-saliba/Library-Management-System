...
public class LibrarianController implements IClient {
	...
	/**
	 * a semaphore that blocks the main thread until a response is received from the
	 * server. semaphore is acquired each time a request to the server is sent and
	 * released after the response arrives.
	 */
	 ...
	 * @return A String containing the return result message (Success, failure w/
	 *         failure reason).
