...
public class DelayController implements IClient {
	...
	public MsgParser checkborrow(String userName, String copyBarcod, enums.BorrowStatus status)
	...
	public enums.Result UpdateBorrowTableAfterDelaying(String userName, String copyBarcode, String librarianID,
			Date returnDate, enums.BorrowStatus status) throws InterruptedException {
		MsgParser<Borrows> msg = new MsgParser<>();
	...
	public enums.Result UpdateDelayTable(String librarianID, Date Date, String userID, String barcode,
			Timestamp borrowDate) throws InterruptedException {
